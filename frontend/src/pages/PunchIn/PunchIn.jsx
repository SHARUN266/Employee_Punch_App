...
function PunchIn() {
  ...
  const handleSubmit = () => {
    ...
    if (location) {
      ...
      alert("Please allow location access to record attendance.");
    }
  };
    ...
    <ContentWrapper>
      <div className="container_login">
        ...
        <div className="right">
          <GoogleMapReact
            bootstrapURLKeys={{
              key: "AIzaSyDm7D2xCvXv_byiQBw2fxPk9g-5BaJoa9k",
            }}
            center={{ lat: location?.lat||25.2165, lng: location?.lng||645.24565 }}
            defaultZoom={15}
